...
import { mottarDuPengestøtteInnhold } from '../../../tekster/opphold';
    ...
    const oppdatertHvilketLandMottarPengestøtte = (e: React.ChangeEvent<HTMLSelectElement>) => {
        settArbeidOgOpphold((prevState) => ({
            ...
            hvilketLandMottarDuPengestøtteFra: {
                label: mottarDuPengestøtteInnhold.select_hvilket_land[locale],
    ...
    return (
        <>
            <LocaleCheckboxGroup
                ...
                tekst={mottarDuPengestøtteInnhold.checkbox_mottar_du_pengestøtte}
