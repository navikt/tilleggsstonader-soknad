...
interface HovedytelseInnhold {
    ...
    arbeidOgOpphold: ArbeidOgOppholdInnhold;
}

interface ArbeidOgOppholdInnhold {
    tittel: TekstElement<string>;
...
export const teksterArbeidOgOpphold: ArbeidOgOppholdInnhold = {
    tittel: {
...
export const hovedytelseInnhold: HovedytelseInnhold = {
    ...
    arbeidOgOpphold: teksterArbeidOgOpphold,
};
