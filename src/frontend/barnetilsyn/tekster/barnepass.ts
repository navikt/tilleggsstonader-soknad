...
export const barnepassTekster: BarnepassInnhold = {
    ...
    startet_femte_readmore: {
        nb: {
            ...
            innhold:
                'Det kan gis støtte etter 4. klasse hvis barnet trenger mer pleie eller hjelp enn det som er vanlig for jevnaldrende eller du har ett tiltak hvor du må være borte fra hjemmet på andre tidspunkter enn en vanlig arbeidsdag.',
        },
    },
