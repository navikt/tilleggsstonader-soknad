import { type LæremidlerSteg, routesLæremidler } from '../læremidler/routing/routesLæremidler';
import { type PassAvBarnSteg, routesPassAvBarn } from '../passAvBarn/routing/routesPassAvBarn';
import {
    type ReiseTilSamlingSteg,
...
export const finnOppsummeringRoute = (skjematype: Skjematype): string =>
    // biome-ignore lint/style/noNonNullAssertion: skal finnes
