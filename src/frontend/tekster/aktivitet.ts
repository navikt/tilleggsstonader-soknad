...
interface AktivitetInnholdFelles {
    ...
    radio_lønnet_tiltak: RadiogruppePåkrevd<JaNei>;
...
export interface AktivitetInnhold extends AktivitetInnholdFelles {
    radio_annet: RadiogruppeMedUtvalgPåkrevd<AnnenAktivitetType>;
    radio_annet_uten_registeraktivitet: RadiogruppeMedUtvalgPåkrevd<AnnenAktivitetType>;
...
export const aktivitetTeksterFelles: AktivitetInnholdFelles = {
    søker_fra: {
        label: { nb: 'Fra hvilken dato søker du om støtte?' },
        feilmelding: { nb: 'Du må fylle inn en gyldig dato' },
    },
    tittel: {
